 ...
 */
export const hasParentWithClassName = (target, className) => [...document.querySelectorAll(`.${className}`)].some(
 ...
 */
export const groupedByCoordinates = mapListings => groupBy(mapListings, l => {
 ...
 */
export const reducedToArray = mapListings => reduce(mapListings, (acc, listing) => acc.concat([listing]), []);
