...
const renderSocialMediaLinks = intl => {
  ...
  const fbLink = siteFacebookPage ? (
    <ExternalLink key="linkToFacebook" className={css.icon} href={siteFacebookPage} title={goToFb}>
      <IconSocialMediaFacebook />
    </ExternalLink>
  ) : null;
      ...
      <div className={css.topBorderWrapper}>
        <div className={css.content}>
          ...
          <div className={css.links}>
            <div className={css.organization} id="organization">
              ...
              <div className={css.organizationInfo}>
                ...
                <p className={css.organizationCopyright}>
                  <NamedLink className={css.copyrightLink} name="LandingPage">
            ...
            <div className={css.infoLinks}>
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink className={css.link} name="AboutPage" to={{ hash: '#contact' }}>
          ...
          <div className={css.copyrightAndTermsMobile}>
            <NamedLink className={css.organizationCopyrightMobile} name="LandingPage">
              <FormattedMessage id="Footer.copyright" />
            </NamedLink>
