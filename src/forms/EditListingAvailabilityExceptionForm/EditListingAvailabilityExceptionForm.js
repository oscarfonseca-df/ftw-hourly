...
const endOfAvailabilityExceptionRange = (timeZone, date) => resetToStartOfDay(date, timeZone, MAX_AVAILABILITY_EXCEPTIONS_RANGE - 1);
...
const getTimeRanges = (timeRanges, date, timeZone) => timeRanges && timeRanges[0] && date
